...
$\lrset{\ket{\varphi_{i}}}_{i = 1}^{N}$, for which the coordinate-space
...
$k_{i} \in \lrset{1, \dotsc, N_{l}}$,
$l_{i} \in \lrset{0, \dotsc, l_{max}}$ and
$m_{i} \in \lrset{-\ell_{i}, \dotsc, \ell_{i}}$, for each
$i \in \lrset{1, 2, \dotsc, N}$, where $N_{l}$ is the total number of radial
basis functions for each ${l}$.
