...
\begin{figure}[h]
  \centering
  % \include{figures/physrevlett-78-4721-sdcs/SDCS}
...
calculation.
Furthermore, the helium target states can have a total spin
$s_{T} \in \lrset{0, 1}$, which couples with the spin of the projectile electron
$s_{0} = \tfrac{1}{2}$, increasing the complexity of the spin algebra beyond
that encountered for hydrogen.
...
asymptotic potential, and does not include the potential terms of the helium
target Hamiltonian.
