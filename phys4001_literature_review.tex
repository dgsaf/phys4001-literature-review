...
\begin{equation}
  ...
  ,
\end{equation}
where $\ket*{F_{i}^{\lr{N}}} = \bra*{\Phi_{i}^{\lr{N}}}\ket*{\psi^{\lr{+}}}$ are
...
$\ket*{F_{i}^{\lr{N}}}$ are within the span of the one-electron spin orbitals
...
multichannel expansion of $\ket*{\psi^{\lr{N, +}}}$ will now uniquely determine
$\ket*{\Psi^{\lr{N, +}}}$.
