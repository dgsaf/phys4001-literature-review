...
calculate cross sections for various types of transitions.
For discrete excitations, the partial cross sections can be written in the form
\begin{equation}
  \label{eq:ccc-transition-amplitude}
  \sigma_{f, i}
  =
  \dfrac{k_{f}}{k_{i}}
  \lrabs
  ...
  ,
\end{equation}
where $\sigma_{f, i}$ is the partial cross section for the discrete excition
