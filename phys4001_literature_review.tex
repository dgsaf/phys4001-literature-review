...
projectile energies.
The application of this ansatz to electron-impact ionisation of hydrogen by Bray
...
excitation, in the CCC method and within the context of the S-wave model.
...
As a consequence, there exists a mature body of computational data with which to
compare.
...
\begin{figure}[h]
  \centering
  \resizebox{0.5\textwidth}{!}{\input{SDCS.tex}}
...
Furthermore, it can be seen that the restriction of the SDCS to being non-zero
only for $e_{q_{\alpha}} \in [0, \tfrac{1}{2} E)$ avoids double counting the
...
\begin{figure}[h]
  \centering
  \resizebox{0.5\textwidth}{!}{\includegraphics{S_sdcs.eps}}
