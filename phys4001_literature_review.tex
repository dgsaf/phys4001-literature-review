...
\begin{figure}[h]
  ...
  \caption[e-H Singlet and Triplet SDCS]{
    ...
    electron-impact ionisation of hydrogen in S-wave model.
    The singlet SDCS data points have been connected for clarity, and here the
    step function was presented as an educated guess.
...
treatment.
It was shown by Bray \cite{PhysRevLett.89.273201} that by adjusting the
differential cross sections to account for the behaviour of the Fourier-like
expansions of step-like terms, that the CCC method yields ionisation amplitudes
and differential cross sections which achieve a great level of agreement with
experimental values, as well with calculations obtained using ECS methods.
...
also of helium (within the frozen core model), as well as for double
...
being calculable for the countable number of outgoing projectile electron
energies which satisfy \autoref{eq:asymptotic-ionisation-energy-constraint}.
