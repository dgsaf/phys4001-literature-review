...
Furthermore, we observe that the multichannel expansion is not uniquely defined,
since for any state in the kernel of the multichannel operator,
$\ket*{\omega} \in \ker\lr{1 - \sum_{m = 1}^{n_{\mathrm{e}}}\hat{P}_{0, m}}$,
and constant $\theta$, the multichannel expansion of
$\ket*{\psi^{\lr{N, +}}} + \theta\ket*{\omega}$ will be identical to that of
$\ket*{\psi^{\lr{N, +}}}$.
