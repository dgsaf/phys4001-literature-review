...
\todo[target electron Hilbert spaces]{
  Introduce the target electron Hilbert spaces.
}
\todo[many-electron target Hilbert space]{
  Introduce the many-electron target Hilbert space.
}
